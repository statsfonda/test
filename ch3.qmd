...
Sa loi n'est plus une loi gaussienne, mais une loi de Student à $n-1$ paramètres de liberté $\mathscr{T}_{n-1}$: le calcul de la densité est fait en détails dans @sec-student1 - @sec-student2. 
Les quantiles des lois de Student ont été calculés avec précision. On notera $t_{k,\alpha}$ le quantile symétrique de niveau $\alpha$ de $\mathscr{T}_k$. Alors, 
