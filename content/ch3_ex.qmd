...
On suppose que l'on observe $X_1, \dots, X_n$ i.i.d de loi de Poisson de paramètre $\theta$.
...
Ce raffinement s'appelle *inégalite de Hoeffding-Azuma*. C'est celui que nous avons utilisé dans l'exercice @exr-tanks, lorsque les $X_1, \dotsc, X_n$ sont des tirages *sans remise* dans une urne à $N$ éléments. 
