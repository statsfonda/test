...
Il existe plusieurs techniques générales pour *construire* des estimateurs. Deux se démarquent : la méthode des moments, et la méthode du maximum de vraisemblance. La méthode des moments est naturelle et donne beaucoup des estimateurs avec de bonnes propriétés, mais elle est moins puissante que la méthode du maximum de vraisemblance que nous verrons plus tard. 
